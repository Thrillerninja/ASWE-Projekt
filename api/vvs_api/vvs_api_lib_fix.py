...
from vvspy.trip import __API_URL, __logger, _parse_response


# Added option for getting trips with arrival time not possible in library
...
def get_trips(
    ...
    **kwargs,
    ...
    params = {
        ...
        # new parameter
        "itdDateTimeDepArr": kwargs.get("itdDateTimeDepArr", "dep"), # dep or arr
        # end new parameter
        "itdTime": check_time.strftime("%H%M"),
        # new parameter
        "itdTripDateTimeDepArr": kwargs.get("itdTripDateTimeDepArr", "dep"), # dep or arr
        # end new parameter
